...
@ApplicationScoped
public class OutsourceTransformer extends GenericTransformer<OutsourceEntity, Outsource> {

    @Inject
    Logger log;


    public OutsourceEntity toEntity(Outsource model) {
        try {
            log.debugf("OutsourceTransformer.toEntity model: %s", model);
    ...
    public Outsource toModel(OutsourceEntity entity) {
        try {
            log.debugf("OutsourceTransformer.toModel entity: %s", entity);
    ...
    public OutsourceEntity copyToAttached(OutsourceEntity detached, OutsourceEntity attached) {
        try {
            log.debugf("OutsourceTransformer.copyToAttached");
